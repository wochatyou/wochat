...
#define REVERSE_LOCK(g) typename std::decay<decltype(g)>::type::reverse_lock BC_UNIQUE_NAME(revlock)(g, #g, __FILE__, __LINE__)
...
#define LOCK(cs) UniqueLock BC_UNIQUE_NAME(criticalblock)(MaybeCheckNotHeld(cs), #cs, __FILE__, __LINE__)
